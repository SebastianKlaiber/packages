...
class MarkdownBuilder implements md.NodeVisitor {
  ...
  Widget _buildImage(String src) {
    ...
    } else if (uri.scheme == 'sfid') {
      String id = src.split(':').last;
      String imageUrl =
          'https://s3.eu-central-1.amazonaws.com/project-sata-loyalty-prod/$id';
      child = new Image.network(imageUrl, width: width, height: height);
    } else {
